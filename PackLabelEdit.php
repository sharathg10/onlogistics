...
$order = Object::load('ChainCommand', $_REQUEST['cmdId']);
$chainCommandList = $order->getCommandItemCollection();

if (!count($chainCommandList)) {
    Template::errorDialog(E_NO_RECORD_FOUND);
    exit(1);
}

$gen = new PackLabelGenerator($chainCommandList);
$pdf = $gen->render();
$pdf->output();
