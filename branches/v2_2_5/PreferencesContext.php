...
if (isset($_POST['Ok'])) {
    ...
    if (isset($_POST['WineContext'])) {
        $tradeContext[] = 'wine';
    }
    if (isset($_POST['EOTSContext'])) {
        $tradeContext[] = 'eots';
    }
...
$smarty->assign('WineContext',
        (is_array($olContext) && in_array('wine', $olContext)));
$smarty->assign('EOTSContext',
        (is_array($olContext) && in_array('eots', $olContext)));
