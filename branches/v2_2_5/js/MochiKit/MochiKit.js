...
MochiKit.DragAndDrop.Droppables={drops:[],remove:function(_714){
this.drops=MochiKit.Base.filter(function(d){
return d.element!=MochiKit.DOM.getElement(_714);
},this.drops);
...
},prepare:function(_719){
MochiKit.Base.map(function(drop){
if(drop.isAccepted(_719)){
if(drop.options.activeclass){
MochiKit.DOM.addElementClass(drop.element,drop.options.activeclass);
}
drop.options.onactive(drop.element,_719);
}
},this.drops);
},findDeepestChild:function(_71b){
deepest=_71b[0];
for(i=1;i<_71b.length;++i){
if(MochiKit.DOM.isParent(_71b[i].element,deepest.element)){
deepest=_71b[i];
}
}
return deepest;
},show:function(_71c,_71d){
...
if(drop.isAffected(_71c,_71d)){
_71e.push(drop);
}
});
if(_71e.length>0){
drop=this.findDeepestChild(_71e);
MochiKit.Position.within(drop.element,_71c.page.x,_71c.page.y);
drop.options.onhover(_71d,drop.element,MochiKit.Position.overlap(drop.options.overlap,drop.element));
drop.activate();
}
},fire:function(_720,_721){
if(!this.last_active){
return;
}
MochiKit.Position.prepare();
if(this.last_active.isAffected(_720.mouse(),_721)){
this.last_active.options.ondrop(_721,this.last_active.element,_720);
}
},reset:function(_722){
MochiKit.Base.map(function(drop){
if(drop.options.activeclass){
...
drop.options.ondesactive(drop.element,_722);
},this.drops);
if(this.last_active){
this.last_active.deactivate();
}
}};
MochiKit.DragAndDrop.Droppable=function(_724,_725){
var cls=arguments.callee;
if(!(this instanceof cls)){
...
MochiKit.DragAndDrop.Droppable.prototype={__class__:MochiKit.DragAndDrop.Droppable,__init__:function(_727,_728){
var d=MochiKit.DOM;
var b=MochiKit.Base;
this.element=d.getElement(_727);
this.options=b.update({greedy:true,hoverclass:null,activeclass:null,hoverfunc:b.noop,accept:null,onactive:b.noop,ondesactive:b.noop,onhover:b.noop,ondrop:b.noop,containment:[],tree:false},_728||{});
...
},isContained:function(_72c){
if(this.options._containers.length){
var _72d;
if(this.options.tree){
_72d=_72c.treeNode;
}else{
_72d=_72c.parentNode;
}
...
},isAccepted:function(_72f){
return ((!this.options.accept)||MochiKit.Iter.some(this.options.accept,function(c){
return MochiKit.DOM.hasElementClass(_72f,c);
}));
},isAffected:function(_731,_732){
return ((this.element!=_732)&&this.isContained(_732)&&this.isAccepted(_732)&&MochiKit.Position.within(this.element,_731.page.x,_731.page.y));
},deactivate:function(){
...
MochiKit.DragAndDrop.Draggables={drags:[],register:function(_733){
...
this.drags.push(_733);
},unregister:function(_735){
...
},activate:function(_738){
window.focus();
this.activeDraggable=_738;
},deactivate:function(){
this.activeDraggable=null;
},updateDrag:function(_739){
if(!this.activeDraggable){
return;
}
var _73a=_739.mouse();
if(this._lastPointer&&(MochiKit.Base.repr(this._lastPointer.page)==MochiKit.Base.repr(_73a.page))){
return;
}
this._lastPointer=_73a;
this.activeDraggable.updateDrag(_739,_73a);
},endDrag:function(_73b){
if(!this.activeDraggable){
return;
}
this._lastPointer=null;
this.activeDraggable.endDrag(_73b);
this.activeDraggable=null;
},keyPress:function(_73c){
if(this.activeDraggable){
this.activeDraggable.keyPress(_73c);
}
},notify:function(_73d,_73e,_73f){
MochiKit.Signal.signal(this,_73d,_73e,_73f);
}};
MochiKit.DragAndDrop.Draggable=function(_740,_741){
var cls=arguments.callee;
if(!(this instanceof cls)){
...
MochiKit.DragAndDrop.Draggable.prototype={__class__:MochiKit.DragAndDrop.Draggable,__init__:function(_743,_744){
var v=MochiKit.Visual;
var b=MochiKit.Base;
_744=b.update({handle:false,starteffect:function(_747){
this._savedOpacity=MochiKit.Style.getStyle(_747,"opacity")||1;
new v.Opacity(_747,{duration:0.2,from:this._savedOpacity,to:0.7});
},reverteffect:function(_748,_749,_74a){
var dur=Math.sqrt(Math.abs(_749^2)+Math.abs(_74a^2))*0.02;
return new v.Move(_748,{x:-_74a,y:-_749,duration:dur});
},endeffect:function(_74c){
new v.Opacity(_74c,{duration:0.2,from:0.7,to:this._savedOpacity});
},onchange:b.noop,zindex:1000,revert:false,scroll:false,scrollSensitivity:20,scrollSpeed:15,snap:false},_744||{});
var d=MochiKit.DOM;
this.element=d.getElement(_743);
if(_744.handle&&(typeof (_744.handle)=="string")){
this.handle=d.getFirstElementByTagAndClassName(null,_744.handle,this.element);
}
if(!this.handle){
this.handle=d.getElement(_744.handle);
}
if(!this.handle){
this.handle=this.element;
}
if(_744.scroll&&!_744.scroll.scrollTo&&!_744.scroll.outerHTML){
_744.scroll=d.getElement(_744.scroll);
this._isScrollChild=MochiKit.DOM.isChildNode(this.element,_744.scroll);
}
d.makePositioned(this.element);
...
},initDrag:function(_74f){
if(!_74f.mouse().button.left){
return;
}
var src=_74f.target();
var _751=(src.tagName||"").toUpperCase();
if(_751==="INPUT"||_751==="SELECT"||_751==="OPTION"||_751==="BUTTON"||_751==="TEXTAREA"){
return;
}
if(this._revert){
this._revert.cancel();
...
this.offset=[_752.page.x-pos.x,_752.page.y-pos.y];
MochiKit.DragAndDrop.Draggables.activate(this);
_74f.stop();
},startDrag:function(_754){
this.dragging=true;
...
var _755=this._getWindowScroll(this.options.scroll);
this.originalScrollLeft=_755.left;
this.originalScrollTop=_755.top;
}else{
...
MochiKit.DragAndDrop.Draggables.notify("start",this,_754);
if(this.options.starteffect){
this.options.starteffect(this.element);
}
},updateDrag:function(_756,_757){
if(!this.dragging){
this.startDrag(_756);
}
MochiKit.Position.prepare();
MochiKit.DragAndDrop.Droppables.show(_757,this.element);
MochiKit.DragAndDrop.Draggables.notify("drag",this,_756);
this.draw(_757);
...
var _75b=[0,0];
if(_757.page.x>(q.x-this.options.scrollSensitivity)){
_75b[0]=_757.page.x-(q.x-this.options.scrollSensitivity);
}else{
if(_757.page.x<(p.x+this.options.scrollSensitivity)){
_75b[0]=_757.page.x-(p.x+this.options.scrollSensitivity);
}
}
if(_757.page.y>(q.y-this.options.scrollSensitivity)){
_75b[1]=_757.page.y-(q.y-this.options.scrollSensitivity);
}else{
if(_757.page.y<(p.y+this.options.scrollSensitivity)){
_75b[1]=_757.page.y-(p.y+this.options.scrollSensitivity);
}
}
this.startScrolling(_75b);
}
if(/AppleWebKit'/.test(navigator.appVersion)){
window.scrollBy(0,0);
}
_756.stop();
},finishDrag:function(_75c,_75d){
...
if(_75d){
dr.Droppables.fire(_75c,this.element);
}
dr.Draggables.notify("end",this,_75c);
var _75f=this.options.revert;
if(_75f&&typeof (_75f)=="function"){
_75f=_75f(this.element);
}
var d=this.currentDelta();
if(_75f&&this.options.reverteffect){
...
},keyPress:function(_761){
if(_761.key().string!="KEY_ESCAPE"){
return;
}
this.finishDrag(_761,false);
_761.stop();
},endDrag:function(_762){
if(!this.dragging){
return;
}
this.stopScrolling();
this.finishDrag(_762,true);
_762.stop();
},draw:function(_763){
var pos=MochiKit.Position.cumulativeOffset(this.element);
var d=this.currentDelta();
...
var p=[_763.page.x-pos.x-this.offset[0],_763.page.y-pos.y-this.offset[1]];
...
},startScrolling:function(_76b){
if(!_76b[0]&&!_76b[1]){
return;
}
this.scrollSpeed=[_76b[0]*this.options.scrollSpeed,_76b[1]*this.options.scrollSpeed];
this.lastScrolled=new Date();
this.scrollInterval=setInterval(MochiKit.Base.bind(this.scroll,this),10);
},scroll:function(){
var _76c=new Date();
var _76d=_76c-this.lastScrolled;
this.lastScrolled=_76c;
if(this.options.scroll==window){
var s=this._getWindowScroll(this.options.scroll);
...
this.options.scroll.scrollLeft+=this.scrollSpeed[0]*_76d/1000;
this.options.scroll.scrollTop+=this.scrollSpeed[1]*_76d/1000;
}
...
d.Draggables._lastScrollPointer.x+=this.scrollSpeed[0]*_76d/1000;
d.Draggables._lastScrollPointer.y+=this.scrollSpeed[1]*_76d/1000;
...
MochiKit.Base.update(MochiKit.Sortable,{sortables:{},_findRootElement:function(_775){
while(_775.tagName.toUpperCase()!="BODY"){
if(_775.id&&MochiKit.Sortable.sortables[_775.id]){
return _775;
}
_775=_775.parentNode;
}
},options:function(_776){
_776=MochiKit.Sortable._findRootElement(MochiKit.DOM.getElement(_776));
if(!_776){
return;
}
return MochiKit.Sortable.sortables[_776.id];
},destroy:function(_777){
var s=MochiKit.Sortable.options(_777);
var b=MochiKit.Base;
var d=MochiKit.DragAndDrop;
if(s){
...
},create:function(_77d,_77e){
_77d=MochiKit.DOM.getElement(_77d);
var self=MochiKit.Sortable;
_77e=MochiKit.Base.update({element:_77d,tag:"li",dropOnEmpty:false,tree:false,treeTag:"ul",overlap:"vertical",constraint:"vertical",containment:[_77d],handle:false,only:false,hoverclass:null,ghosting:false,scroll:false,scrollSensitivity:20,scrollSpeed:15,format:/^[^_]*_(.*)$/,onChange:MochiKit.Base.noop,onUpdate:MochiKit.Base.noop,accept:null},_77e);
self.destroy(_77d);
var _780={revert:true,ghosting:_77e.ghosting,scroll:_77e.scroll,scrollSensitivity:_77e.scrollSensitivity,scrollSpeed:_77e.scrollSpeed,constraint:_77e.constraint,handle:_77e.handle};
if(_77e.starteffect){
_780.starteffect=_77e.starteffect;
}
if(_77e.reverteffect){
_780.reverteffect=_77e.reverteffect;
}else{
if(_77e.ghosting){
_780.reverteffect=function(_781){
_781.style.top=0;
_781.style.left=0;
};
}
...
if(_77e.endeffect){
_780.endeffect=_77e.endeffect;
}
if(_77e.zindex){
_780.zindex=_77e.zindex;
}
var _782={overlap:_77e.overlap,containment:_77e.containment,hoverclass:_77e.hoverclass,onhover:self.onHover,tree:_77e.tree,accept:_77e.accept};
var _783={onhover:self.onEmptyHover,overlap:_77e.overlap,containment:_77e.containment,hoverclass:_77e.hoverclass,accept:_77e.accept};
MochiKit.DOM.removeEmptyTextNodes(_77d);
_77e.draggables=[];
_77e.droppables=[];
if(_77e.dropOnEmpty||_77e.tree){
new MochiKit.DragAndDrop.Droppable(_77d,_783);
_77e.droppables.push(_77d);
}
MochiKit.Base.map(function(e){
var _785=_77e.handle?MochiKit.DOM.getFirstElementByTagAndClassName(null,_77e.handle,e):e;
_77e.draggables.push(new MochiKit.DragAndDrop.Draggable(e,MochiKit.Base.update(_780,{handle:_785})));
new MochiKit.DragAndDrop.Droppable(e,_782);
if(_77e.tree){
e.treeNode=_77d;
}
_77e.droppables.push(e);
},(self.findElements(_77d,_77e)||[]));
if(_77e.tree){
MochiKit.Base.map(function(e){
new MochiKit.DragAndDrop.Droppable(e,_783);
e.treeNode=_77d;
_77e.droppables.push(e);
},(self.findTreeElements(_77d,_77e)||[]));
}
self.sortables[_77d.id]=_77e;
_77e.lastValue=self.serialize(_77d);
_77e.startHandle=MochiKit.Signal.connect(MochiKit.DragAndDrop.Draggables,"start",MochiKit.Base.partial(self.onStart,_77d));
_77e.endHandle=MochiKit.Signal.connect(MochiKit.DragAndDrop.Draggables,"end",MochiKit.Base.partial(self.onEnd,_77d));
},onStart:function(_787,_788){
var self=MochiKit.Sortable;
var _78a=self.options(_787);
_78a.lastValue=self.serialize(_78a.element);
},onEnd:function(_78b,_78c){
var self=MochiKit.Sortable;
self.unmark();
var _78e=self.options(_78b);
if(_78e.lastValue!=self.serialize(_78e.element)){
_78e.onUpdate(_78e.element);
}
},findElements:function(_78f,_790){
return MochiKit.Sortable.findChildren(_78f,_790.only,_790.tree?true:false,_790.tag);
},findTreeElements:function(_791,_792){
return MochiKit.Sortable.findChildren(_791,_792.only,_792.tree?true:false,_792.treeTag);
},findChildren:function(_793,only,_795,_796){
if(!_793.hasChildNodes()){
return null;
}
_796=_796.toUpperCase();
if(only){
only=MochiKit.Base.flattenArray([only]);
}
var _797=[];
MochiKit.Base.map(function(e){
if(e.tagName&&e.tagName.toUpperCase()==_796&&(!only||MochiKit.Iter.some(only,function(c){
return MochiKit.DOM.hasElementClass(e,c);
}))){
_797.push(e);
}
if(_795){
var _79a=MochiKit.Sortable.findChildren(e,only,_795,_796);
if(_79a&&_79a.length>0){
_797=_797.concat(_79a);
}
}
},_793.childNodes);
return _797;
},onHover:function(_79b,_79c,_79d){
if(MochiKit.DOM.isParent(_79c,_79b)){
return;
}
var self=MochiKit.Sortable;
if(_79d>0.33&&_79d<0.66&&self.options(_79c).tree){
return;
}else{
if(_79d>0.5){
self.mark(_79c,"before");
if(_79c.previousSibling!=_79b){
var _79f=_79b.parentNode;
_79b.style.visibility="hidden";
_79c.parentNode.insertBefore(_79b,_79c);
if(_79c.parentNode!=_79f){
self.options(_79f).onChange(_79b);
}
self.options(_79c.parentNode).onChange(_79b);
}
}else{
self.mark(_79c,"after");
var _7a0=_79c.nextSibling||null;
if(_7a0!=_79b){
var _79f=_79b.parentNode;
_79b.style.visibility="hidden";
_79c.parentNode.insertBefore(_79b,_7a0);
if(_79c.parentNode!=_79f){
self.options(_79f).onChange(_79b);
}
self.options(_79c.parentNode).onChange(_79b);
...
},_offsetSize:function(_7a1,type){
if(type=="vertical"||type=="height"){
return _7a1.offsetHeight;
}else{
return _7a1.offsetWidth;
}
},onEmptyHover:function(_7a3,_7a4,_7a5){
var _7a6=_7a3.parentNode;
var self=MochiKit.Sortable;
var _7a8=self.options(_7a4);
if(!MochiKit.DOM.isParent(_7a4,_7a3)){
var _7a9;
var _7aa=self.findElements(_7a4,{tag:_7a8.tag,only:_7a8.only});
var _7ab=null;
if(_7aa){
var _7ac=self._offsetSize(_7a4,_7a8.overlap)*(1-_7a5);
for(_7a9=0;_7a9<_7aa.length;_7a9+=1){
if(_7ac-self._offsetSize(_7aa[_7a9],_7a8.overlap)>=0){
_7ac-=self._offsetSize(_7aa[_7a9],_7a8.overlap);
}else{
if(_7ac-(self._offsetSize(_7aa[_7a9],_7a8.overlap)/2)>=0){
_7ab=_7a9+1<_7aa.length?_7aa[_7a9+1]:null;
break;
}else{
_7ab=_7aa[_7a9];
break;
...
_7a4.insertBefore(_7a3,_7ab);
self.options(_7a6).onChange(_7a3);
_7a8.onChange(_7a3);
}
},unmark:function(){
...
},mark:function(_7ae,_7af){
var d=MochiKit.DOM;
var self=MochiKit.Sortable;
var _7b2=self.options(_7ae.parentNode);
if(_7b2&&!_7b2.ghosting){
return;
}
if(!self._marker){
...
var _7b3=MochiKit.Position.cumulativeOffset(_7ae);
self._marker.style.left=_7b3.x+"px";
self._marker.style.top=_7b3.y+"px";
if(_7af=="after"){
if(_7b2.overlap=="horizontal"){
self._marker.style.left=(_7b3.x+_7ae.clientWidth)+"px";
}else{
self._marker.style.top=(_7b3.y+_7ae.clientHeight)+"px";
}
}
MochiKit.Style.showElement(self._marker);
},_tree:function(_7b4,_7b5,_7b6){
var self=MochiKit.Sortable;
var _7b8=self.findElements(_7b4,_7b5)||[];
for(var i=0;i<_7b8.length;++i){
var _7ba=_7b8[i].id.match(_7b5.format);
if(!_7ba){
continue;
}
var _7bb={id:encodeURIComponent(_7ba?_7ba[1]:null),element:_7b4,parent:_7b6,children:[],position:_7b6.children.length,container:self._findChildrenElement(_7b8[i],_7b5.treeTag.toUpperCase())};
if(_7bb.container){
self._tree(_7bb.container,_7b5,_7bb);
}
_7b6.children.push(_7bb);
}
return _7b6;
},_findChildrenElement:function(_7bc,_7bd){
if(_7bc&&_7bc.hasChildNodes){
_7bd=_7bd.toUpperCase();
for(var i=0;i<_7bc.childNodes.length;++i){
if(_7bc.childNodes[i].tagName.toUpperCase()==_7bd){
return _7bc.childNodes[i];
}
}
}
return null;
},tree:function(_7bf,_7c0){
_7bf=MochiKit.DOM.getElement(_7bf);
var _7c1=MochiKit.Sortable.options(_7bf);
_7c0=MochiKit.Base.update({tag:_7c1.tag,treeTag:_7c1.treeTag,only:_7c1.only,name:_7bf.id,format:_7c1.format},_7c0||{});
var root={id:null,parent:null,children:new Array,container:_7bf,position:0};
return MochiKit.Sortable._tree(_7bf,_7c0,root);
},setSequence:function(_7c3,_7c4,_7c5){
var self=MochiKit.Sortable;
var b=MochiKit.Base;
_7c3=MochiKit.DOM.getElement(_7c3);
_7c5=b.update(self.options(_7c3),_7c5||{});
var _7c8={};
b.map(function(n){
var m=n.id.match(_7c5.format);
if(m){
_7c8[m[1]]=[n,n.parentNode];
}
n.parentNode.removeChild(n);
},self.findElements(_7c3,_7c5));
b.map(function(_7cb){
var n=_7c8[_7cb];
if(n){
n[1].appendChild(n[0]);
...
do{
if(node.id){
_7ce="["+node.position+"]"+_7ce;
}
}while((node=node.parent)!=null);
return _7ce;
},sequence:function(_7cf,_7d0){
_7cf=MochiKit.DOM.getElement(_7cf);
var self=MochiKit.Sortable;
var _7d0=MochiKit.Base.update(self.options(_7cf),_7d0||{});
return MochiKit.Base.map(function(item){
return item.id.match(_7d0.format)?item.id.match(_7d0.format)[1]:"";
},MochiKit.DOM.getElement(self.findElements(_7cf,_7d0)||[]));
},serialize:function(_7d3,_7d4){
_7d3=MochiKit.DOM.getElement(_7d3);
var self=MochiKit.Sortable;
_7d4=MochiKit.Base.update(self.options(_7d3),_7d4||{});
var name=encodeURIComponent(_7d4.name||_7d3.id);
if(_7d4.tree){
...
},self.tree(_7d3,_7d4).children)).join("&");
}else{
return MochiKit.Base.map(function(item){
return name+"[]="+encodeURIComponent(item);
},self.sequence(_7d3,_7d4)).join("&");
}
}});
...
(function(){
var _7db=MochiKit.Base.extend;
var self=MochiKit.MochiKit;
var _7dd=self.SUBMODULES;
var _7de=[];
var _7df=[];
var _7e0={};
var i,k,m,all;
for(i=0;i<_7dd.length;i++){
m=MochiKit[_7dd[i]];
_7db(_7de,m.EXPORT);
_7db(_7df,m.EXPORT_OK);
for(k in m.EXPORT_TAGS){
_7e0[k]=_7db(_7e0[k],m.EXPORT_TAGS[k]);
}
all=m.EXPORT_TAGS[":all"];
if(!all){
all=_7db(null,m.EXPORT,m.EXPORT_OK);
}
var j;
...
var _7e6=document.getElementsByTagName("script");
var _7e7="http://www.mozilla.org/keymaster/gatekeeper/there.is.only.xul";
var base=null;
var _7e9=null;
var _7ea={};
var i;
for(i=0;i<_7e6.length;i++){
var src=_7e6[i].getAttribute("src");
if(!src){
continue;
}
_7ea[src]=true;
...
var _7ed=MochiKit.MochiKit.SUBMODULES;
for(var i=0;i<_7ed.length;i++){
if(MochiKit[_7ed[i]]){
continue;
}
var uri=base+_7ed[i]+".js";
if(uri in _7ea){
continue;
}
if(document.documentElement&&document.documentElement.namespaceURI==_7e7){
var s=document.createElementNS(_7e7,"script");
s.setAttribute("id","MochiKit_"+base+_7ed[i]);
s.setAttribute("src",uri);
s.setAttribute("type","application/x-javascript");
_7e9.parentNode.appendChild(s);
}else{
