...
class AeroConcreteProduct extends _AeroConcreteProduct {
     ...
     * Retourne true si l'appareil est disponible pour le créneau $start-$end
     *
    ...
    function isAvailableFor($start, $end){
        ...
        if (!($wplanning instanceof WeeklyPlanning)) {
            trigger_error("ConcreteProduct::isAvailableFor(): l'appareil " .
                $this->toString() ." n'a pas de planning affecté. Veuillez  " .
    ...
    /**
     * Retourne une collection des prestationsCost associées au
     * concreteproduct, à son product, et à son flytype, c a d
    ...
    /**
     * Retourne une collection des Prestations associées au
     * concreteproduct, à son product, et à son flytype
     *
     * @access public
