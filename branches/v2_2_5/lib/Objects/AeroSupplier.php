...
class AeroSupplier extends AeroActor {
    
    // Constructeur {{{

    /**
     * AeroSupplier::__construct()
     * Constructeur
     *
     * @access public
     * @return void
    ...
    // }}}
    // OnlogisticsAccount string property + getter/setter {{{

    /**
     * OnlogisticsAccount string property
     *
     * @access private
     * @var string
     */
    private $_OnlogisticsAccount = null;

    /**
     * AeroSupplier::getOnlogisticsAccount
     *
     * @access public
     * @return string
     */
    public function getOnlogisticsAccount() {
        return $this->_OnlogisticsAccount;
    }

    /**
     * AeroSupplier::setOnlogisticsAccount
     *
     * @access public
     * @param string $value
     * @return void
     */
    public function setOnlogisticsAccount($value) {
        $this->_OnlogisticsAccount = $value;
    }
    ...
    public static function getProperties($ownOnly = false) {
        $return = array(
            'OnlogisticsAccount' => Object::TYPE_STRING);
