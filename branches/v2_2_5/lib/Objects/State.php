...
class State extends _State {
    ...
    /**
     * Retourne true ou false selon s'il n'existe pas déjà de State 
     * avec le meme couple (Country, Name)
     * @access public
     * @return void 
     **/
