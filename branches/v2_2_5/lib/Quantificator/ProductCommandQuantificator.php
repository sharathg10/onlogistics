...
class ProductCommandQuantificator extends Quantificator 
{
    ...
    /**
     * Contient toutes les données de quantifications necessaires à la classe
     * pour évaluer les durées et les couts des tâches de la chaine.
     *
     * @var    array $data
     * @access private
     */
    ...
    /**
     * Prépare les données de quantification avant lancement du
     * parent::execute qui lui va lancer la méthode processTask() pour chaque 
     * tâche.
     *
     * @return void
     */
    ...
    /**
     * Retourne le multiplicateur pour le calcul de la durée en fonction du
     * type de durée passé en paramètre.
     *
     * @access protected
