 ...
 * @version   SVN: $Id: ProductForLabelPrintingGrid.php 71 2008-07-07 09:03:06Z izimobil $
...
class ProductForLabelPrintingGrid extends GenericGrid
{
    // Constructeur {{{
    ...
    // }}} 
    //  ProductForLabelPrintingGrid::getMapping() {{{
    ...
    // }}} 
    // ProductForLabelPrintingGrid::getFeatures() {{{
    ...
    // }}}
    // ProductForLabelPrintingGrid::getGridFilter() {{{
    ...
    // }}}
    // ProductForLabelPrintingGrid::additionalGridActions() {{{
    ...
    // }}}
    // ProductForLabelPrintingGrid::additionalGridColumns() {{{
