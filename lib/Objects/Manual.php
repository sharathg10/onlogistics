...
class Manual extends Object {
    ...
    // }}}
    // FrFile string property + getter/setter {{{

    /**
     * FrFile string property
     *
     * @access private
     * @var string
     */
     ...
     * @return void
     */
    public function setFrFile($value) {
        $this->_FrFile = $value;
    }

    // }}}
    // EnFile string property + getter/setter {{{

    /**
     * EnFile string property
     *
     * @access private
     * @var string
     */
     ...
     * @return void
     */
    public function setEnFile($value) {
        $this->_EnFile = $value;
    }
    ...
    public static function getProperties() {
        $return = array(
            ...
            'FrFile' => Object::TYPE_STRING,
            'EnFile' => Object::TYPE_STRING);
        return $return;
    }
