...
class PrestationCommandItem extends _PrestationCommandItem {
    // Constructeur {{{

    /**
     * PrestationCommandItem::__construct()
     * Constructeur
     *
     * @access public
     * @return void
    ...
    /**
     * Méthode ajouté pour trié les commandItem par le nom de la prestation
     */
