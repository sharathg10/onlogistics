 ...
 **/
if (!isset($_REQUEST['prtIds']) || !is_array($_REQUEST['prtIds'])) {
...
/**
 * On supprime les types de produits sélectionnées 
 **/
$prtMapper = Mapper::singleton('ProductType');

foreach($_REQUEST['prtIds'] as $prtID){
	$prtMapper->delete($prtID);
}
