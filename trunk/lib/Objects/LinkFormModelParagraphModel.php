...
class LinkFormModelParagraphModel extends Object {
    
    // Constructeur {{{

    /**
     * LinkFormModelParagraphModel::__construct()
     * Constructeur
     *
     * @access public
     * @return void
    ...
    // }}}
    // ParagraphOrder int property + getter/setter {{{

    /**
     * ParagraphOrder int property
     *
     * @access private
     * @var integer
     */
    private $_ParagraphOrder = null;

    /**
     * LinkFormModelParagraphModel::getParagraphOrder
     *
     * @access public
     * @return integer
     */
    ...
    /**
     * LinkFormModelParagraphModel::setParagraphOrder
     *
     * @access public
     * @param integer $value
     * @return void
    ...
    public function setParagraphOrder($value) {
        $this->_ParagraphOrder = ($value===null || $value === '')?null:(int)$value;
    }
    ...
    /**
     * LinkFormModelParagraphModel::getParagraphModel
     *
     * @access public
    ...
    /**
     * LinkFormModelParagraphModel::getParagraphModelId
     *
     * @access public
     * @return integer
     */
    ...
    /**
     * LinkFormModelParagraphModel::setParagraphModel
     *
     * @access public
     ...
     */
    private $_FormModel = false;

    /**
     * LinkFormModelParagraphModel::getFormModel
     *
     * @access public
    ...
    /**
     * LinkFormModelParagraphModel::getFormModelId
     *
     * @access public
     * @return integer
     */
    ...
    /**
     * LinkFormModelParagraphModel::setFormModel
     *
     * @access public
    ...
    public static function getTableName() {
        return 'LinkFormModelParagraphModel';
    }
    ...
    public static function getProperties() {
        $return = array(
            'ParagraphOrder' => Object::TYPE_INT,
