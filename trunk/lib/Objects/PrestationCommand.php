...
class PrestationCommand extends Command {
    // class constants {{{
    ...
    public static function getStateConstArray($keys = false) {
        $array = array(
            PrestationCommand::ACTIVEE => _("Activated"), 
            PrestationCommand::FACT_PARTIELLE => _("Partially charged"), 
            PrestationCommand::FACT_COMPLETE => _("Completely charged"), 
            PrestationCommand::REGLEMT_PARTIEL => _("Partially paid"), 
            PrestationCommand::REGLEMT_TOTAL => _("Completely paid")
        );
        asort($array);
