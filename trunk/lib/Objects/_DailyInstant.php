...
class _DailyInstant extends AbstractInstant {
    
    // Constructeur {{{

    /**
     * _DailyInstant::__construct()
     * Constructeur
     *
     * @access public
     * @return void
    ...
    // }}}
    // Time datetime property + getter/setter {{{
    ...
    public function getTime($format = false) {
        return $this->dateFormat($this->_Time, $format);
    }

    /**
     * _DailyInstant::setTime
     *
     * @access public
     * @param string $value
     * @return void
